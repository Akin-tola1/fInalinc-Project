...
st.markdown("<h4 style='text-align: center; margin-top: 0rem; color: #514BFF;'>BUILT BY DEJI</h4>", unsafe_allow_html=True)

st.image('pngwing.com (8).png', width=250, use_column_width=True)
...
st.sidebar.image('pngwing.com (1).png', width=100, use_column_width=True, caption='Welcome User')
